...
const Hero = () => {
  ...
  return (
    ...
    <section className="relative min-h-[690px] bg-gradient-to-r from-primary to-secondary w-full md:rounded-xl shadow-md">
        <div className="container">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 place-items-center min-h-[650px]">
                    ...
                    <div className="text-white mt-[100px] md:mt-0 p-4 space-y-4">
                        ...
                        <h1 data-aos="fade-up" data-aos-delay="300" className="text-5xl font-bold uppercase text-shadow">A Healthy 
                        Fruit</h1>
                        <p data-aos="fade-up" data-aos-delay="500" className="text-sm">Lorem ipsum, dolor sit amet
        ...
        <h1 data-aos="fade" data-aos-delay="600" data-aos-duration="2200"  className="large-text">Orange</h1>
